...
export default function AuthorSection() {
  return (
    <section
      id="sobre"
      className="relative py-16 sm:py-24 bg-[#050509] overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 max-w-4xl mx-auto">
          {PROJECTS.map((p, idx) => (
            <motion.div
              ...
              className="group rounded-card bg-[#111117] border border-white/10 p-6 sm:p-8 hover:border-blue-500/40 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10"
            >
              <div
                className={`w-12 h-12 rounded-xl bg-gradient-to-br ${p.accent} flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}
              >
